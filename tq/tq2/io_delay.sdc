...
set_output_delay -clock [get_clocks {ram_clk}] -max   [expr $DATA_TSU + $BOARD_PD] [get_ports {data*}]   
set_output_delay -clock [get_clocks {ram_clk}] -min  -[expr $DATA_TH  + $BOARD_PD] [get_ports {data*}]
