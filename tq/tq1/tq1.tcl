...
report_timing -to_clock { dac_clock } -setup -npaths 10 -detail full_path -panel_name {DAC||Setup: dac_clk}
report_timing -to_clock { dac_clock } -hold  -npaths 10 -detail full_path -panel_name {DAC||Hold: dac_clk}
